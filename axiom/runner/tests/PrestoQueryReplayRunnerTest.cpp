...
TEST_F(PrestoQueryReplayRunnerTest, joinWithTableScan) {
  std::vector<velox::RowVectorPtr> tables = {
      /*T*/
...
TEST_F(PrestoQueryReplayRunnerTest, unsupported) {
  ...
  auto pool = rootPool->addLeafChild("testLeafPool");
  {
    ...
    EXPECT_EQ(status, PrestoQueryReplayRunner::Status::kUnsupported);
  }

  // Arbitrary partition is not supported yet.
  queryId = "def";
  serializedPlanFragments = {
      R"({"task_id":"cde.1.0.0.0","execution_strategy":"UNGROUPED","remote_task_ids":{},"plan_fragment":{"outputType":{"names":["c0","a0"],"cTypes":[{"type":"BIGINT","name":"Type"},{"type":"BIGINT","name":"Type"}],"type":"ROW","name":"Type"},"serdeKind":"Presto","replicateNullsAndAny":false,"partitionFunctionSpec":{"name":"GatherPartitionFunctionSpec"},"numPartitions":1,"sources":[{"ignoreNullKeys":false,"globalGroupingSets":[],"aggregates":[{"distinct":false,"sortingOrders":[],"sortingKeys":[],"rawInputTypes":[{"type":"INTEGER","name":"Type"}],"call":{"inputs":[{"inputs":[{"type":{"cTypes":[{"type":"BIGINT","name":"Type"},{"type":"INTEGER","name":"Type"}],"names":["c0","c1"],"type":"ROW","name":"Type"},"name":"InputTypedExpr"}],"fieldName":"c1","type":{"type":"INTEGER","name":"Type"},"name":"FieldAccessTypedExpr"}],"functionName":"sum","type":{"type":"BIGINT","name":"Type"},"name":"CallTypedExpr"}}],"aggregateNames":["a0"],"preGroupedKeys":[],"step":"SINGLE","groupingKeys":[{"fieldName":"c0","type":{"type":"BIGINT","name":"Type"},"name":"FieldAccessTypedExpr"}],"sources":[{"projections":[{"functionName":"mod","inputs":[{"inputs":[{"type":{"cTypes":[{"type":"BIGINT","name":"Type"},{"type":"INTEGER","name":"Type"}],"names":["c0","c1"],"type":"ROW","name":"Type"},"name":"InputTypedExpr"}],"fieldName":"c0","type":{"type":"BIGINT","name":"Type"},"name":"FieldAccessTypedExpr"},{"value":{"value":3,"type":"BIGINT"},"type":{"type":"BIGINT","name":"Type"},"name":"ConstantTypedExpr"}],"type":{"type":"BIGINT","name":"Type"},"name":"CallTypedExpr"},{"fieldName":"c1","inputs":[{"type":{"names":["c0","c1"],"cTypes":[{"type":"BIGINT","name":"Type"},{"type":"INTEGER","name":"Type"}],"type":"ROW","name":"Type"},"name":"InputTypedExpr"}],"type":{"type":"INTEGER","name":"Type"},"name":"FieldAccessTypedExpr"}],"sources":[{"data":"","parallelizable":false,"repeatTimes":1,"id":"0","name":"ValuesNode"}],"names":["c0","c1"],"id":"1","name":"ProjectNode"}],"id":"2","name":"AggregationNode"}],"keys":[],"kind":"ARBITRARY","id":"3","name":"PartitionedOutputNode"}})",
  };
  {
    PrestoQueryReplayRunner runner{pool.get(), getTaskPrefix};
    auto [result, status] = runner.run(queryId, serializedPlanFragments, {});
